package com.example.user.fauzan_1202152161_modul1;
...
public class Review extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = null;
        if(price < 65000) {
            toast = Toast.makeText(getApplicationContext(), "Makan sini aja yuk dek", Toast.LENGTH_SHORT);
        }else{
            toast = Toast.makeText(getApplicationContext(), "Makan tempat lain aja yuk dek", Toast.LENGTH_SHORT);
        }
        toast.show();
    }
}
